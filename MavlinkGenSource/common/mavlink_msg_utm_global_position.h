...
#define MAVLINK_MSG_ID_UTM_GLOBAL_POSITION 334
...
typedef struct __mavlink_utm_global_position_t {
 ...
 int32_t alt; /*< [mm] Altitude (WGS84), in meters * 1000.*/
 int32_t relative_alt; /*< [mm] Altitude above ground in meters * 1000.*/
 uint32_t h_acc; /*< [mm] Horizontal Position uncertainty in meters * 1000. (standard deviation)*/
 uint32_t v_acc; /*< [mm] Altitude uncertainty in meters * 1000. (standard deviation)*/
 uint32_t vel_acc; /*< [mm/s] Speed uncertainty in m/s * 1000. (standard deviation)*/
 int32_t next_lat; /*< [degE7] Next waypoint, Latitude (WGS84), in degrees * 1E7.*/
 int32_t next_lon; /*< [degE7] Next waypoint, Longitude (WGS84), in degrees * 1E7.*/
 int32_t next_alt; /*< [mm] Next waypoint, Altitude (WGS84), in meters * 1000.*/
 ...
 uint8_t flight_state; /*<  The flight state defined in enum \verb|UTM_FLIGHT_STATE|.*/
 uint8_t flags; /*<  Bitwise OR combination of the enums \verb|UTM_DATA_AVAIL_FLAGS|.*/
}) mavlink_utm_global_position_t;

#define MAVLINK_MSG_ID_UTM_GLOBAL_POSITION_LEN 76
#define MAVLINK_MSG_ID_UTM_GLOBAL_POSITION_MIN_LEN 76
#define MAVLINK_MSG_ID_334_LEN 76
#define MAVLINK_MSG_ID_334_MIN_LEN 76

#define MAVLINK_MSG_ID_UTM_GLOBAL_POSITION_CRC 184
#define MAVLINK_MSG_ID_334_CRC 184
...
#define MAVLINK_MESSAGE_INFO_UTM_GLOBAL_POSITION { \
    ...
    {  { "time", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_utm_global_position_t, time) }, \
         { "uas_id", NULL, MAVLINK_TYPE_UINT8_T, 18, 56, offsetof(mavlink_utm_global_position_t, uas_id) }, \
         ...
         { "vx", NULL, MAVLINK_TYPE_INT16_T, 0, 48, offsetof(mavlink_utm_global_position_t, vx) }, \
         { "vy", NULL, MAVLINK_TYPE_INT16_T, 0, 50, offsetof(mavlink_utm_global_position_t, vy) }, \
         { "vz", NULL, MAVLINK_TYPE_INT16_T, 0, 52, offsetof(mavlink_utm_global_position_t, vz) }, \
         { "h_acc", NULL, MAVLINK_TYPE_UINT32_T, 0, 24, offsetof(mavlink_utm_global_position_t, h_acc) }, \
         { "v_acc", NULL, MAVLINK_TYPE_UINT32_T, 0, 28, offsetof(mavlink_utm_global_position_t, v_acc) }, \
         { "vel_acc", NULL, MAVLINK_TYPE_UINT32_T, 0, 32, offsetof(mavlink_utm_global_position_t, vel_acc) }, \
         { "next_lat", NULL, MAVLINK_TYPE_INT32_T, 0, 36, offsetof(mavlink_utm_global_position_t, next_lat) }, \
         { "next_lon", NULL, MAVLINK_TYPE_INT32_T, 0, 40, offsetof(mavlink_utm_global_position_t, next_lon) }, \
         { "next_alt", NULL, MAVLINK_TYPE_INT32_T, 0, 44, offsetof(mavlink_utm_global_position_t, next_alt) }, \
         { "update_rate", NULL, MAVLINK_TYPE_UINT16_T, 0, 54, offsetof(mavlink_utm_global_position_t, update_rate) }, \
         { "flight_state", NULL, MAVLINK_TYPE_UINT8_T, 0, 74, offsetof(mavlink_utm_global_position_t, flight_state) }, \
         { "flags", NULL, MAVLINK_TYPE_UINT8_T, 0, 75, offsetof(mavlink_utm_global_position_t, flags) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_UTM_GLOBAL_POSITION { \
 ...
 * @param alt [mm] Altitude (WGS84), in meters * 1000.
 * @param relative_alt [mm] Altitude above ground in meters * 1000.
 ...
 * @param h_acc [mm] Horizontal Position uncertainty in meters * 1000. (standard deviation)
 * @param v_acc [mm] Altitude uncertainty in meters * 1000. (standard deviation)
 * @param vel_acc [mm/s] Speed uncertainty in m/s * 1000. (standard deviation)
 * @param next_lat [degE7] Next waypoint, Latitude (WGS84), in degrees * 1E7.
 * @param next_lon [degE7] Next waypoint, Longitude (WGS84), in degrees * 1E7.
 * @param next_alt [mm] Next waypoint, Altitude (WGS84), in meters * 1000.
 * @param update_rate  Seconds * 1E2 until next update. Set to 0 if unknown or in data driven mode.
 * @param flight_state  The flight state defined in enum \verb|UTM_FLIGHT_STATE|.
 * @param flags  Bitwise OR combination of the enums \verb|UTM_DATA_AVAIL_FLAGS|.
...
static inline uint16_t mavlink_msg_utm_global_position_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint64_t time, const uint8_t *uas_id, int32_t lat, int32_t lon, int32_t alt, int32_t relative_alt, int16_t vx, int16_t vy, int16_t vz, uint32_t h_acc, uint32_t v_acc, uint32_t vel_acc, int32_t next_lat, int32_t next_lon, int32_t next_alt, uint16_t update_rate, uint8_t flight_state, uint8_t flags)
{
    ...
    _mav_put_uint32_t(buf, 32, vel_acc);
    _mav_put_int32_t(buf, 36, next_lat);
    _mav_put_int32_t(buf, 40, next_lon);
    _mav_put_int32_t(buf, 44, next_alt);
    _mav_put_int16_t(buf, 48, vx);
    _mav_put_int16_t(buf, 50, vy);
    _mav_put_int16_t(buf, 52, vz);
    _mav_put_uint16_t(buf, 54, update_rate);
    _mav_put_uint8_t(buf, 74, flight_state);
    _mav_put_uint8_t(buf, 75, flags);
    _mav_put_uint8_t_array(buf, 56, uas_id, 18);
...
static inline void mavlink_msg_utm_global_position_send(mavlink_channel_t chan, uint64_t time, const uint8_t *uas_id, int32_t lat, int32_t lon, int32_t alt, int32_t relative_alt, int16_t vx, int16_t vy, int16_t vz, uint32_t h_acc, uint32_t v_acc, uint32_t vel_acc, int32_t next_lat, int32_t next_lon, int32_t next_alt, uint16_t update_rate, uint8_t flight_state, uint8_t flags)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_UTM_GLOBAL_POSITION_LEN];
    _mav_put_uint64_t(buf, 0, time);
...
{
    return _MAV_RETURN_uint8_t_array(msg, uas_id, 18,  56);
}
 ...
 *
 * @return [mm] Altitude (WGS84), in meters * 1000.
 */
 ...
 *
 * @return [mm] Altitude above ground in meters * 1000.
 */
 ...
 *
 * @return [mm] Horizontal Position uncertainty in meters * 1000. (standard deviation)
 */
static inline uint32_t mavlink_msg_utm_global_position_get_h_acc(const mavlink_message_t* msg)
{
 ...
 *
 * @return [mm] Altitude uncertainty in meters * 1000. (standard deviation)
 */
static inline uint32_t mavlink_msg_utm_global_position_get_v_acc(const mavlink_message_t* msg)
{
 ...
 *
 * @return [mm/s] Speed uncertainty in m/s * 1000. (standard deviation)
 */
static inline uint32_t mavlink_msg_utm_global_position_get_vel_acc(const mavlink_message_t* msg)
{
 ...
 *
 * @return [degE7] Next waypoint, Latitude (WGS84), in degrees * 1E7.
 */
 ...
 *
 * @return [degE7] Next waypoint, Longitude (WGS84), in degrees * 1E7.
 */
 ...
 *
 * @return [mm] Next waypoint, Altitude (WGS84), in meters * 1000.
 */
 ...
 *
 * @return  The flight state defined in enum \verb|UTM_FLIGHT_STATE|.
 */
 ...
 *
 * @return  Bitwise OR combination of the enums \verb|UTM_DATA_AVAIL_FLAGS|.
 */
